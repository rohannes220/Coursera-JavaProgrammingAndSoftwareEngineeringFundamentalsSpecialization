...
public class BabyBirths
{
    ...
    public void testGetName(){
        ...
        String [] expectedOutputs = {"Sophia","NO NAME","Ava","Isabella","NO NAME","Mason","Jacob","NO NAME","Noah", "NO NAME", "William"}; 
    ...
    public int yearOfHighestRank(String name, String gender){
        ...
        //highestYear = -1 b/c it is easier to return the year if the name isnt there in any file
